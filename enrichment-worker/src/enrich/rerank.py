...
# Default weights
DEFAULT_WEIGHTS = {
    'alpha': 0.18,    # HF model probability
    'beta': 0.18,     # Secondary similarity
    'gamma': 0.26,    # Domain prior
    'delta': 0.22,    # Control alignment
    'epsilon': 0.04,  # Polarity alignment
    'zeta': 0.12      # Event valence
}

# Domain prior table (8 domains × 6 emotions)
DOMAIN_PRIOR = {
    'work': {
        'Happy': -0.3, 'Strong': +0.5, 'Peaceful': -0.5,
        'Sad': +0.3, 'Angry': +1.0, 'Fearful': +0.5
    },
    'relationship': {
        'Happy': +0.5, 'Strong': -0.5, 'Peaceful': +0.3,
        'Sad': +1.0, 'Angry': +0.5, 'Fearful': +0.5
    },
    'family': {
        'Happy': +0.5, 'Strong': -0.5, 'Peaceful': +0.3,
        'Sad': +1.0, 'Angry': -0.5, 'Fearful': +0.5
    ...
    'social': {
        'Happy': +0.5, 'Strong': -0.5, 'Peaceful': +0.3,
        'Sad': +1.0, 'Angry': +0.3, 'Fearful': +0.5
    },
    'self': {
        'Happy': +0.3, 'Strong': +0.3, 'Peaceful': +0.5,
        'Sad': +1.0, 'Angry': -0.5, 'Fearful': +0.3
    }
}
