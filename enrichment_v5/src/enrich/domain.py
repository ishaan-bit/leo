...
DOMAIN_KEYWORDS_V1 = {
    'work': [
        ...
        'workplace', 'career', 'professional'
    ],
    'relationship': [
        'relationship', 'partner', 'girlfriend', 'boyfriend', 'spouse', 'wife',
        'husband', 'dating', 'love', 'romance', 'breakup', 'together', 'couple',
        'commitment', 'trust', 'intimacy', 'she didn\'t reply', 'he didn\'t reply',
        'text back', 'reply to my message', 'ignored me', 'left me on read'
    ],
    'family': [
        'family', 'mom', 'dad', 'mother', 'father', 'parent', 'sibling', 'brother',
        'sister', 'child', 'son', 'daughter', 'grandparent', 'relative', 'uncle',
        'aunt', 'cousin', 'home', 'household', 'parents', 'meet my family',
        'family se', 'from my family'
    ],
    'health': [
        'health', 'sick', 'illness', 'disease', 'doctor', 'hospital', 'medical',
        'medicine', 'treatment', 'pain', 'injury', 'surgery', 'therapy', 'symptom',
        'diagnosis', 'recovery', 'exercise', 'fitness', 'diet', 'tired all the time',
        'exhausted', 'feel tired', 'health looks', 'health reports', 'checkup'
    ],
    'money': [
        'money', 'financial', 'finance', 'debt', 'loan', 'payment', 'bill',
        'expense', 'budget', 'savings', 'salary', 'income', 'rent', 'mortgage',
        'investment', 'bank', 'credit', 'afford', 'financially', 'paid off',
        'hanging by a thread financially', 'bank balance', 'broke'
    ],
    'study': [
        'study', 'exam', 'test', 'assignment', 'homework', 'class', 'course',
        'lecture', 'professor', 'teacher', 'grade', 'school', 'college', 'university',
        'education', 'learning', 'student', 'degree', 'thesis', 'studying', 
        'sit to study', 'scrolling instead of studying', 'fail an exam'
    ],
    'social': [
        'friend', 'friends', 'social', 'party', 'hangout', 'gathering', 'event',
        'community', 'group', 'circle', 'acquaintance', 'peer', 'networking',
        'invitation', 'celebration', 'dinner today', 'old times with my friends',
        'said something harsh to my friend'
    ],
    'self': [
