...
export async function GET(req: NextRequest) {
  ...
  console.log('[Dream Gate] Full URL:', req.url);
  console.log('[Dream Gate] Headers:', Object.fromEntries(req.headers.entries()));
  console.log('==========================================');
  ...
  try {
    ...
    if (!auth) {
      console.log('!!!!! NO AUTH - REDIRECTING TO REFLECT');
    ...
    console.log('!!!!! FORCE DREAM CHECK RESULT:', JSON.stringify(forceDreamCheck, null, 2));
    console.log('!!!!! FORCE DREAM ENABLED:', forceDream);
    
    if (!forceDream) {
      console.log('!!!!! FORCE DREAM DISABLED - EXITING TO REFLECT');
      return NextResponse.redirect(new URL(`/reflect/${pigId}`, req.url));
    }
