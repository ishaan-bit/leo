 ...
 * 3 options: Continue as Guest | Sign in with Google | Sign in with Phone
 */
      ...
      <div className="relative z-10 w-full max-w-lg flex-1 flex flex-col items-center justify-center space-y-8 py-8 px-6">
        ...
        >
          ...
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/90 backdrop-blur-sm border-2 border-pink-200 text-pink-900 font-semibold py-4 px-6 rounded-2xl shadow-md hover:shadow-lg hover:border-pink-300 transition-all duration-300"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
