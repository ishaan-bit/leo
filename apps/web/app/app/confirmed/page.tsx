/**
 * /app/confirmed - 5s Settle Screen (Signed-in)
 * 
 ...
 * Auto-transitions to /app/moment after 5 seconds with CSS blend
 */
...
export default function AppConfirmedPage() {
  ...
  useEffect(() => {
    ...
    const fetchPig = async () => {
      try {
        ...
        console.error('[App Confirmed] Error fetching pig:', err);
        router.replace('/app/name-pig');
      }
    };
